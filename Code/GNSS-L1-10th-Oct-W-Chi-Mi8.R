...
dft <- read.csv("PR_L1_prefit-10thOct2022_Mi8.csv",header=T)

df <- read.csv("NSSE_PR_L1-10thoct2023_Mi8.csv",header=T)
...
# Method-1 : Chi-square -> t-test #  (Manual Threshold ~ 0.93 - 0.97)
...
row_values <- dft[139, ]
e_values <- row_values[!is.na(row_values)]
plot(e_values,main = "Passed Chi-Square Test | Epoch 139",ylim = c(-30,30),xlab="Satellites",ylab="Standardized Residuals")
abline(h=0,col="red")

row_values <- dft[141, ]
e_values <- row_values[!is.na(row_values)]
plot(e_values,main = "Passed Chi-Square Test | Epoch 141",ylim = c(-30,30),xlab="Satellites",ylab="Standardized Residuals")
abline(h=0,col="red")
...
abline(h=0,col="red")
points(y = e_values[11], x = 3,col = "orange", pch = 16) 
text(y=e_values[11],x=3 ,labels = "Transformed", pos = 1, col = "orange")
par(mfrow=c(1,2))
row_values <- to_be_tested[47, ]
e_values <- row_values[!is.na(row_values)]
...
plot(e_values,main = "t-test Process at Epoch 47",ylim = c(-30,30),xlab="Satellites",ylab="Standardized Residuals")
abline(h=0,col="red")

points(y=e_values[9], x = c(9),col = "orange", pch = 16) 
text(y=e_values[9],x=c(9), labels = "Transformed", pos = 3, col = "orange")
points(y=e_values[12], x = c(12),col = "navyblue", pch = 16) 
text(y=e_values[12],x=c(12), labels = "Outlier", pos = 1, col = "navyblue")

abline(h=mean(e_values),col="black",lty=2)
abline(h=c0*e_SE + e_mean,col="orange",lty=5)
abline(h=c1*e_SE + e_mean,col="navyblue",lty=5)
abline(h=-c0*e_SE + e_mean,col="orange",lty=5)
abline(h=-c1*e_SE + e_mean,col="navyblue",lty=5)
...
y0_values <- rep(c0*e_SE + e_mean,n+2)
y1_values <- rep(c1*e_SE + e_mean,n+2)

polygon(x = c(x0_values,x1_values),y = c(y0_values,y1_values),col="#FFA50050",angle = 45)
polygon(x = c(x0_values,x1_values),y = c(y0_values,y1_values),col="#FFA50050",density = 10,angle = 45)

polygon(x = c(x0_values,x1_values),y = c(y1_values,rep(33,n+2)),col="#6495ED50",angle = 45)
polygon(x = c(x0_values,x1_values),y = c(y1_values,rep(33,n+2)),col="#6495ED50",density = 10,angle = 45)
...
legend("topleft", legend=c("Outlier Area", "Transform Area", "Safe Zone"), 
       fill=c("#6495ED50", "#FFA50050", "white"), bty="n",border=c("#6495ED50", "#FFA50050", "black"),cex = 0.5) 
# Add "Mean" label to y-axis
axis(2, at = e_mean, labels = "Mean", col = "black", las = 1)


# Highlighted points
highlight_points <- list(Transformed = list(x = 9, color = "orange"),
                         Outlier = list(x = 12, color = "navyblue"))

# Plot highlighted points and add text
for (point in highlight_points) {
  # Add arrows with numerical labels indicating differences
  diff <- e_values[point$x] - mean_e
  arrows(x0 = point$x, y0 = e_values[point$x], x1 = point$x, y1 = mean_e, length = 0.1,col=point$color)
}
...
row_values <- to_be_tested[47, ]
e_values <- row_values[!is.na(row_values)]
plot(e_values,main = "LOF Process at Epoch 47",ylim = c(-30,30),xlab="Satellites",ylab="Standardized Residuals")
abline(h=0,col="red")
points(y=e_values[12], x = c(12),col = "orange", pch = 16) 
text(y=e_values[12],x=c(12), labels = "Transformed (r = 3.8)", pos = 3, col = "orange")
points(y=e_values[9], x = c(9),col = "navyblue", pch = 16) 
text(y=e_values[9],x=c(9), labels = "Outlier (r = 3)", pos = 3, col = "navyblue")
symbols(x = 12, y = e_values[12], circles = 0.5, add = TRUE, inches = 3.65, fg = "orange",
        bg = adjustcolor("#FFA50050", alpha.f = 0.5),lwd = 2)
symbols(x = 9, y = e_values[9], circles = 0.5, add = TRUE, inches = 2.25, fg = "navyblue", 
        bg = adjustcolor("#6495ED50", alpha.f = 0.5), lwd = 2)

points(y=e_values[c(7,8,11)], x = c(7,8,11),col = "brown", pch = 16) 
text(y=e_values[c(7,8,11)], x = c(7,8,11),labels = c("r=2.56","r=2.6",
                                                       "r=2.56"),col = "brown", pos = 3) 

points(y=e_values[c(5,6)], x = c(5,6),col = "#483D8B", pch = 16) 
text(y=e_values[c(5,6)], x = c(5,6),labels=c("r=2.3","r=2.4"),col = "#483D8B", pos = 3) 
points(y=e_values[c(10,13)], x = c(10,13),col = "#FF8C00", pch = 16) 
text(y=e_values[c(10,13)], x = c(10,13),labels=c("r=3.1","r=5"),col = "#FF8C00", pos = 3) 
legend("topleft",legend=c("Outlier (r): 3 / avg(5) = 1.2116","Transform (r): 3.8 / avg(5) = 1.2010"),
       pch=c(21,21),col=c("navyblue","orange"),
       pt.bg = c(rgb(72, 61, 139, alpha = 100, maxColorValue = 255),  # navyblue with alpha value
                 rgb(255, 165, 0, alpha = 100, maxColorValue = 255)),pt.lwd=c(1,1),lty=c(0,0),pt.cex=c(5,5),cex=0.5,bty = "n")
...
abline(h=0,col="red")
points(y=e_values[11], x = 11,col = "navyblue", pch = 16) 
text(y=e_values[11],x=11, labels = "Outlier", pos = 3, col = "navyblue")
...
row_values <- to_be_tested[47, ]
e_values <- row_values[!is.na(row_values)]
plot(e_values,main = "IF Process at Epoch 47",ylim = c(-30,30),xlab="Satellites",ylab="Standardized Residuals")
abline(h=0,col="red")
points(y = e_values[c(9,12)], x = c(9,12),col = "navyblue", pch = 16) 
text(y=e_values[c(9,12)],x=c(9,12) ,labels = "Outlier", pos = 3, col = "navyblue")


# Method-4 : Chi-square -> Isolation Forest -> LOF # (Manual Threshold ~ 0.5 -> 1)
...
#which(h_if_lof_ch[[47]]==1)
#which(h_if_lof_ch[[47]]==2)
...
row_values <- to_be_tested[47, ]
e_values <- row_values[!is.na(row_values)]
plot(e_values,main = "IF-LOF Process at Epoch 47",ylim = c(-30,30),xlab="Satellites",ylab="Standardized Residuals")
abline(h=0,col="red")
points(y=e_values[9], x = c(9),col = "orange", pch = 16) 
text(y=e_values[9],x=c(9), labels = "Transformed", pos = 3, col = "orange")
points(y=e_values[11], x = c(11),col = "navyblue", pch = 16) 
text(y=e_values[11],x=c(11), labels = "Outlier", pos = 3, col = "navyblue")
...
for (col in 1:max(ncol(result_t),ncol(result_lof))) {
  ...
  if (col > ncol(result_t)) {
    ...
    for (k in 1:length(y2)) {
      if(y2[k]==0) next
      else{points(x = x[k], y = y2[k],col="navyblue",pch=15)
        text(paste("",y2[k]),x = x[k], y = y2[k],col="navyblue",pos = 2)
    ...
    for (j in 1:length(y)) {
      if (y[j]==0) {
        if (y2[j]==0) {
          ...
          text(paste("",y2[j]),x = x[j], y = y2[j],col="navyblue",pos = 2)
...
plot(x = 1, y = result_lof[1,1], ylim = c(0,140),xlim=c(0,25) ,type = "p", col = "white", xlab = "Epoch", ylab = "Satellite",
     main="Transform Detection on the Satellites for first 20 Epoch")
